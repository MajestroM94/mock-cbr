...
const (
	CurrencyService_GetDaily_FullMethodName = "/proto.CurrencyService/GetDaily"
)
...
type CurrencyServiceClient interface {
	GetDaily(ctx context.Context, in *DailyRequest, opts ...grpc.CallOption) (*DailyResponse, error)
}
...
func (c *currencyServiceClient) GetDaily(ctx context.Context, in *DailyRequest, opts ...grpc.CallOption) (*DailyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DailyResponse)
	err := c.cc.Invoke(ctx, CurrencyService_GetDaily_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CurrencyServiceServer interface {
	GetDaily(context.Context, *DailyRequest) (*DailyResponse, error)
...
func (UnimplementedCurrencyServiceServer) GetDaily(context.Context, *DailyRequest) (*DailyResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetDaily not implemented")
}
...
func _CurrencyService_GetDaily_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DailyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CurrencyServiceServer).GetDaily(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CurrencyService_GetDaily_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CurrencyServiceServer).GetDaily(ctx, req.(*DailyRequest))
	}
...
var CurrencyService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetDaily",
			Handler:    _CurrencyService_GetDaily_Handler,
		},
	},
